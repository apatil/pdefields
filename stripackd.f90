...
! Modified by AP, 19 April 2011: nrow set to 9, defined nt.
subroutine trlist ( n, nt, list, lptr, lend, ltri, ier )
!f2py intent(hide) n
!f2py intent(out) ier, ltri
!
!*******************************************************************************
!
...
!    NN =       Local copy of N
!
!f2py intent(hide) n, near, next, dist
!f2py intent(out) list, lptr, lend, lnew, ier
  implicit none
!
  integer n
!
